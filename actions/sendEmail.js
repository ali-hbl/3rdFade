...
export async function sendContactEmail(formData) {
    ...
    const emailPayload = {
      ...
      <p><strong>Téléphone :</strong> ${safePhone || 'Non communiqué'}</p>
      <p><strong>Type de projet :</strong> ${safeProject || 'Non communiqué'}</p>
      <p><strong>Budget estimé :</strong> ${safeBudget || 'Non communiqué'}</p>
